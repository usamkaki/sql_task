...
CALL insert_values('Kashif','9867525','Vellore');

CALL insert_values('Yasir','9629677','Bangalore');

CALL insert_values('Hammad','8796542','Coimbatore');

CALL insert_values('Usaid','8796519','Salem');
